...
```
 ...
 Based on the Fisher XY tests above, which compare two racial groups at a time, we can tell that the attitudes of white and black people toward capital punishment are different based on the low p-value of 5.75e-14. The attitudes of white and others toward capital punishment, on the other hand, are the same based on the p-value of 0.0002819 . And lastly, the attitudes of black people are others are also different based on the low p-value of 0.02479.
